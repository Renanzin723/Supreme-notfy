...
const BrandItau = () => {
  useEffect(() => {
    ...
    const metaTags = [
      { name: 'apple-mobile-web-app-title', content: 'Itaú' },
      { name: 'apple-mobile-web-app-capable', content: 'yes' },
      { name: 'apple-mobile-web-app-status-bar-style', content: 'black' },
      { name: 'theme-color', content: '#EC7000' },
    ];
    ...
    manifestLink.setAttribute('href', '/manifests/itau.webmanifest');
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-500 to-orange-700 flex items-center justify-center p-4">
      <div className="max-w-md mx-auto text-center text-white">
        <div className="w-32 h-32 mx-auto mb-6 rounded-3xl bg-white/10 backdrop-blur flex items-center justify-center shadow-2xl">
          <BankLogo bank="itau" size={96} />
        </div>
        
        <h1 className="text-4xl font-bold mb-4">Itaú</h1>
